        ...
        <div className="flex-1 text-left">
          <div className="flex flex-col items-center mb-2">
            ...
            <p className="mb-8 text-foreground/90 text-justify pl-4 pr-2 font-medium transition-colors duration-300">
              Soy Ingeniero de Sistemas, pero sobre todo, alguien que disfruta entender cómo funcionan las cosas para mejorarlas. Mi camino en la tecnología empezó resolviendo problemas en soporte técnico y fue creciendo hacia la administración de sistemas y la ciberseguridad. He trabajado con entornos Windows y Linux, gestionando infraestructura TI, directorios, redes y plataformas empresariales como MS365 y sistemas de telefonía IP. Con Python desarrollo herramientas que automatizan tareas, analizan entornos y hacen la vida más fácil a usuarios y técnicos. Me gusta lo práctico, lo que funciona, pero también lo que se puede hacer mejor. Git, SQL, virtualización y la seguridad informática son parte de mi día a día. ¡La tecnología es mi vida!
            </p>
            <div className="mt-16">

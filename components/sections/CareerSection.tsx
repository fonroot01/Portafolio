  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        "Pruebas de penetración en máquinas vulnerables usando Metasploit",
        "Implementación de entornos con Windows Server y administración de dominios con Active Directory",
        "Automatización de tareas de ciberseguridad con Python",
        "Consulta y análisis de datos mediante SQL",
      ],
      description:
        "Durante este tiempo, he reforzado mis conocimientos técnicos mediante cursos, laboratorios y práctica constante en entornos controlados. Actualmente curso el programa de Ciberseguridad de Google a través de Coursera (con convenio SENATIC), fortaleciendo así mi base técnica y experiencia práctica.",
    },
    {
      ...
      responsibilities: [
        "Apoyé en la administración y configuración de sistemas de telefonía IP, software contable y licencias",
        "Realicé respaldos de información, verificación de plataformas y revisión de inventarios tecnológicos",
        "Brindé soporte técnico básico, escalamientos y seguimiento de incidentes según instrucciones recibidas",
        "Colaboré en la documentación de casos y procedimientos operativos",
      ],
      skills: [
    ...
    },
    {
      ...
      logo: "/career/logozeuss.png",
      responsibilities: [
        "Apoyé tareas de mantenimiento preventivo y correctivo de equipos de cómputo",
        "Atendí incidentes y solicitudes de usuarios bajo supervisión",
        "Realicé actividades básicas en servidores y estaciones de servicio",
        "Contribuí en la documentación de procedimientos y en la capacitación de usuarios",
      ],
    },
    {

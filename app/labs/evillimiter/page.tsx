    ...
    <div className="container py-8 px-4 mx-auto max-w-4xl">
      ...
      <div className="bg-muted p-6 rounded-lg mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li className="text-white text-justify">Python 3.x instalado en el sistema</li>
          <li className="text-white text-justify">Acceso root/administrador</li>
          <li className="text-white text-justify">NetfilterQueue (para el manejo de paquetes)</li>
          <li className="text-white text-justify">Conexión a una red local con permisos de prueba</li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="bg-muted p-4 rounded-md overflow-x-auto mb-4">
          <p className="font-semibold mb-2 text-white text-justify">Solución al error común de NetfilterQueue:</p>
          <pre className="text-sm">
            <code>
